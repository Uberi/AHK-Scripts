...
pre, .codecontent, code, .gist-data pre { font-family: Consolas, Inconsolata, Monaco, "DejaVu Sans Mono", "Bitstream Vera Sans Mono", "Lucida Console", monospace !important; }
...
#indexstats, #onlinelist, #perms { display: none; }