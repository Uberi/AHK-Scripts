...
; NOTE: EFX-UTIL.H contains mostly arrays. Not included in this file yet!
; NOTE: All functions in xram.h have been commented out in the latest version
;       of the OpenAL headers. None are included here.
...
; efx-creative.h
	 ...
	 ; Array
	 VarSetCapacity(AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN, 12, 0)
	 NumPut(0.0, AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN, 0, "Float")
	 NumPut(0.0, AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN, 4, "Float")
	 NumPut(0.0, AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN, 8, "Float")
	 ;AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN               {0.0f, 0.0f, 0.0f}
	 ...
	 ; Array
	 VarSetCapacity(AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN, 12, 0)
	 NumPut(0.0, AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN, 0, "Float")
	 NumPut(0.0, AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN, 4, "Float")
	 NumPut(0.0, AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN, 8, "Float")
	 ;AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN               {0.0f, 0.0f, 0.0f}
