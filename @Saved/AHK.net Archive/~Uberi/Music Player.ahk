...
{
 Return, !!DllCall("winmm\mciSendStringA","Str","open """ . FileName . """ alias " . Alias,"UInt",0,"Int",0,"UInt",0,"Cdecl")
}

MediaClose(ByRef hMedia)
{
 Return, !!DllCall("winmm\mciSendStringA","Str","close " . hMedia,"UInt",0,"Int",0,"UInt",0,"Cdecl")
}

MediaPlay(ByRef hMedia,Wait = 0)
{
 Return, !!DllCall("winmm\mciSendStringA","Str","play " . hMedia . (Wait ? " wait" : ""),"UInt",0,"Int",0,"UInt",0,"Cdecl")
}

MediaStop(ByRef hMedia)
{
 Return, (DllCall("winmm\mciSendStringA","Str","seek " . hMedia . " to start","UInt",0,"Int",0,"UInt",0,"Cdecl") && DllCall("winmm\mciSendStringA","Str","stop " . hMedia,"UInt",0,"Int",0,"UInt",0,"Cdecl"))
}

MediaPause(ByRef hMedia)
{
 Return, !!DllCall("winmm\mciSendStringA","Str","pause " . hMedia,"UInt",0,"Int",0,"UInt",0,"Cdecl")
}

MediaResume(ByRef hMedia)
{
 Return, !!DllCall("winmm\mciSendStringA","Str","resume " . hMedia,"UInt",0,"Int",0,"UInt",0,"Cdecl")
}

MediaLength(ByRef hMedia,ByRef Length)
{
 If (DllCall("winmm\mciSendStringA","Str","set time format milliseconds","UInt",0,"Int",0,"UInt",0,"Cdecl") <> 263)
  Return, 1
 VarSetCapacity(Length,36,0), DllCall("winmm\mciSendStringA","Str","status " . hMedia . " length","UInt",&Length,"UInt",36,"UInt",0,"Cdecl")
 Return, 0
}
...
MediaSeek(ByRef hMedia,ByRef Position)
{
 If (DllCall("winmm\mciSendStringA","Str","set time format milliseconds","UInt",0,"Int",0,"UInt",0,"Cdecl") <> 263)
  Return, 1
 VarSetCapacity(MediaStatus,36,0), DllCall("winmm\mciSendStringA","Str","status " . hMedia . " mode","UInt",&MediaStatus,"UInt",36,"UInt",0,"Cdecl")
 Return, (DllCall("winmm\mciSendStringA","Str","seek " . hMedia . " to " . Position,"UInt",0,"Int",0,"UInt",0,"Cdecl") || ((MediaStatus = "playing") ? DllCall("winmm\mciSendStringA","Str","play " . hMedia,"UInt",0,"Int",0,"UInt",0,"Cdecl")))
}
...
MediaPosition(ByRef hMedia,ByRef CurrentPos)
{
 If (DllCall("winmm\mciSendStringA","Str","set time format milliseconds","UInt",0,"Int",0,"UInt",0,"Cdecl") <> 263)
  Return, 1
 VarSetCapacity(CurrentPos,36,0), DllCall("winmm\mciSendStringA","Str","status " . hMedia . " position","UInt",&CurrentPos,"UInt",36,"UInt",0,"Cdecl")
 Return, 0
}
