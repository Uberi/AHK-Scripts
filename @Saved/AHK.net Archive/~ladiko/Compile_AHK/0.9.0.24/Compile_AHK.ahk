...
; Der vollst‰ndige Pfad des Scripts muss als Kommandozeilenparameter ¸bergeben
; werden.
; --------------------------------------------------------------------------------
...
_CHECK_EXENAME()
{
	...
	If elevated != 0
	{
		...
		Button2Name = &Abort
		MsgBoxTitle = Choice required
		MsgBoxText = Your executable's filename contains the word "%elevated%". If you continue, Windows Vista will automatically elevate your executable so that it need to run in administration mode.
		SetTimer , ChangeButtonNames , 50
		MsgBox , 289 , %MsgBoxTitle% , %MsgBoxText%
		IfMsgBox , Cancel
...
{
	Global
	Local s_CMD , s_ERR , s_LOG , s_FILE_VER , s_PROD_VER , s_RC_FILE , s_RES_FILE , s_SC_FILE , s_SCRIPT
...
BLOCK "VarFileInfo"
{
	...
	FileAppend , `n# Resource file created successfully!`n`n , %A_WorkingDir%\%LOG_FILE%
...
EXEC_LEVEL_HELP:
	...
	HelpText := "none:`n"
				...
				. A_Space . A_Space . "it launches with users rights.`n`n"
