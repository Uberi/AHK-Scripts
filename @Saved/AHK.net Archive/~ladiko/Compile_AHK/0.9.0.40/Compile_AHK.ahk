...
; --------------------------------------------------------------------------------
	...
	FileDelete , %A_WorkingDir%\%RES_Log%
	FileAppend , `n~~ Reshacker Log Start ~~`n%s_Log%~~ Reshacker Log End ~~`n`n# Versioninfo set successfully!`n`n , %A_WorkingDir%\%Log_File%
...
Import_Resources()
{
	...
	If Errorlevel
	{
		s_ERR := "Couldn't delete " . s_SC_FILE
		_ERROR_EXIT(Error_Message . s_ERR)
	}
	FileAppend , %s_SCRIPT% , %s_SC_FILE%
...
CreateToolTips:
	...
	Loop , %Icon_Count%
	{
		Gui_Icon_%A_Index%_BT_TT := ""
		Gui_Icon_%A_Index%_Pic_TT := ""
		Gui_Icon_%A_Index%_Set_TT := "Set the icon file"
		Gui_Icon_%A_Index%_TT := "This is the icon file."
	}
...
updateLang:
	...
	GuiControl , , Company_Name , %Lang_Resource_ListView%
	GuiControl , , Company_Name_TT , %Lang_Company_Name_TT%
	GuiControl , , File_Description , %Lang_File_Description%
	GuiControl , , File_Description_TT , %Lang_File_Description_TT%
	GuiControl , , File_Version , %Lang_File_Version%
	GuiControl , , FV1_TT , %Lang_FV1_TT%
	GuiControl , , FV2_TT , %Lang_FV2_TT%
	GuiControl , , FV3_TT , %Lang_FV3_TT%
	GuiControl , , FV4_TT , %Lang_FV4_TT%
	GuiControl , , TFV1_TT , %Lang_TFV1_TT%
	GuiControl , , TFV2_TT , %Lang_TFV2_TT%
	GuiControl , , TFV3_TT , %Lang_TFV3_TT%
	GuiControl , , TFV4_TT , %Lang_TFV4_TT%
	GuiControl , , Internal_Name , %Lang_Internal_Name%
	GuiControl , , Internal_Name_TT , %Lang_Internal_Name_TT%
	GuiControl , , Legal_Copyright , %Lang_Legal_Copyright%
	GuiControl , , Legal_Copyright_TT , %Lang_Legal_Copyright_TT%
	GuiControl , , Original_File_Name , %Lang_Original_File_Name%
	GuiControl , , Original_Filename_TT , %Lang_Original_Filename_TT%
	GuiControl , , Product_Name , %Lang_Product_Name%
	GuiControl , , Product_Name_TT , %Lang_Product_Name_TT%
	GuiControl , , Product_Version , %Lang_Product_Version%
	GuiControl , , Set_AHK_Version_TT , %Lang_Set_AHK_Version_TT%
	GuiControl , , PV1_TT , %Lang_PV1_TT%
	GuiControl , , PV2_TT , %Lang_PV2_TT%
	GuiControl , , PV3_TT , %Lang_PV3_TT%
	GuiControl , , PV4_TT , %Lang_PV4_TT%
	GuiControl , , TPV1_TT , %Lang_TPV1_TT%
	GuiControl , , TPV2_TT , %Lang_TPV2_TT%
	GuiControl , , TPV3_TT , %Lang_TPV3_TT%
	GuiControl , , TPV4_TT , %Lang_TPV4_TT%
	GuiControl , , Autoincrement , %Lang_Autoincrement%
	GuiControl , , Inc_File_Version_TT , %Lang_Inc_File_Version_TT%
	GuiControl , , Inc_Product_Version_TT , %Lang_Inc_Product_Version_TT%
	GuiControl , , Set_to_AHK_Version , %Lang_Set_to_AHK_Version%
	GuiControl , , Language_ID , %Lang_Language_ID%
	GuiControl , , Language_ID_TT , %Lang_Language_ID_TT%
	GuiControl , , Charset , %Lang_Charset%
	GuiControl , , Charset_TT , %Lang_Charset_TT%
	GuiControl , , Main_Icon , %Lang_Main_Icon%
	GuiControl , , Shortcut_Icon , %Lang_Shortcut_Icon%
	GuiControl , , Suspend_Icon , %Lang_Suspend_Icon%
	GuiControl , , Pause_Icon , %Lang_Pause_Icon%
	GuiControl , , Suspend_Pause_Icon , %Lang_Suspend_Pause_Icon%
	GuiControl , , Main_Icon_9x , %Lang_Main_Icon_9x%
	GuiControl , , Suspend_Icon_9x , %Lang_Suspend_Icon_9x%
