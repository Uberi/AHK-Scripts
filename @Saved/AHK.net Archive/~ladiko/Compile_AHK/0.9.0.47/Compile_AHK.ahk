...
_SaveIniInScript(InScript)
{
	...
	In_File_Content := RegExReplace(In_File_Content , "/\*`n \* \* \* Compile_AHK SETTINGS BEGIN \* \* \*[\S\s]*\* \* \* Compile_AHK SETTINGS END \* \* \*`n\*/`n`n")
	
	If InScript
	{
		FileRead , Ini_File_Content , %Ini_File%
		FileDelete , %Ini_File%
		In_File_Content := "/*`n * * * Compile_AHK SETTINGS BEGIN * * *`n`n"
			. Ini_File_Content
			. "`n* * * Compile_AHK SETTINGS END * * *`n*/`n`n"
			. In_File_Content
	}
