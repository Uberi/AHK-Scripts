...
COMPR_LEVELS := "None|Lowest|Low|Normal|High|Highest"
...
GUI_UPX_LEVEL := UPX_LEVEL + 2
GuiControl , Choose , GUI_UPX_LEVEL , %GUI_UPX_LEVEL%

Gui , Font , cNavy
Gui , Add , Text , xs y+20 h20 w100 +0x1000 , Password
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w250 vGUI_OUT_PASS Password , %OUT_PASS%
Gui , Add , Button , x+5 yp h20 gGUI_GEN_PWD , &Generate
...
Gui , Add , Checkbox , x+20 yp w360 h20 vGUI_OUT_DCMP Checked%OUT_DCMP% , (AHK v1.0.46.10+)
...
Gui , Add , Text , x+20 yp w100 h20 , Execution Level:
Gui , Add , DropDownList , x+20 yp w150 AltSubmit Choose%EXEC_LEVEL% vGUI_EXEC_LEVEL , none||asInvoker|highestAvailable|requireAdministrator
Gui , Add , Button , x+20 yp w50 h22 gEXEC_LEVEL_HELP , &Help

Gui , Tab , 2

Gui , Add , Checkbox , x+20 y+15 gGUI_CB_VI vGUI_VERSION_INFO Checked%VERSION_INFO% , Set Version Info

Gui , Font , cNavy
Gui , Add , Text , Section xp y+15 h20 w120 +0x1000 , Company Name
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w320 vGUI_COMPANY_NAME , %COMPANY_NAME%

Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , File Description
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w320 vGUI_FILE_DESC , %FILE_DESC%

Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , File Version
Gui , Font , cBlack
...
Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , Internal Name
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w320 vGUI_INTERNAL_NAME , %INTERNAL_NAME%

Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , Legal Copyright
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w320 vGUI_LEGAL_COPYRIGHT , %LEGAL_COPYRIGHT%

Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , Original File Name
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w320 vGUI_ORG_FILENAME , %ORG_FILENAME%

Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , Product Name
Gui , Font , cBlack
Gui , Add , Edit , x+20 yp h20 w320 vGUI_PRODUCT_NAME , %PRODUCT_NAME%

Gui , Font , cNavy
Gui , Add , Text , xs y+15 h20 w120 +0x1000 , Product Version
Gui , Font , cBlack
...
Gui , Font , cNavy
Gui , Add , Text , xs y+7 h20 w120 +0x1000 , Language ID
Gui , Font , cBlack
Gui , Add , DropDownList , x+20 w200 yp AltSubmit Choose%LANG_ID% vGUI_LANG_ID , %LANG_IDS%
Gui , Font , cNavy
Gui , Add , Text , xs y+7 h20 w120 +0x1000 , Charset
Gui , Font , cBlack
...
Gui , Add , Picture , xm+434 ym+4 h16 w16 hidden vGuiOnTop gGuiOnTop_OFF AltSubmit Icon6 , %A_ScriptName%
Gui , Add , Picture , xm+434 ym+4 h16 w16 vGuiOnTop_OFF gGuiOnTop AltSubmit Icon7 , %A_ScriptName%

Gui , Add , Button , xm+454 ym h23 w100 gGuiSaveDefaults , &Save Defaults
Gui , Add , Button , xm+554 ym h23 w60 gShowCredits , C&redits
...
ShowCredits:
	...
	Gui, 2:Font, bold
	Gui 2:Add, Text , x12 vText_1 y%YPos1% , .:[ Compile AHK ]:.
	Gui, 2:Font, norm
...
_MOD_MANIFEST()
{
	...
	s_SCRIPT := s_SCRIPT . "-extract """ . s_MF_FILE . """ , 24 , 1 , 1033"
	...
	s_SCRIPT := s_SCRIPT . "-addoverwrite """ . s_MF_FILE . """ , 24 , 1 , 1033"
...
{
	Global
	Local s_IN , s_OUT , s_ICON , s_PASS , s_DCMP , s_CMD , s_LOG , OLD_UPX_LEVEL
	s_IN := " /in """ . IN_FILE . """"
	s_OUT := " /out """ . OUT_FILE . """"
	/*
	...
	*/
	...
	OLD_UPX_LEVEL := _SET_COMPRESSION(UPX_LEVEL)
	...
	If (ErrorLevel)
	{
		_SET_COMPRESSION(OLD_UPX_LEVEL)
		Return False
	}
...
EXEC_LEVEL_HELP:
	...
	HelpText := "none:`n"
				. A_Space . A_Space . "Doesn't add a special execution level.`n`n"
				. "asInvoker:`n"
				. A_Space . A_Space . "Launches with the same rights as the user or parent process.`n`n"
				. "highestAvailable:`n"
				. A_Space . A_Space . "Launches with the highest rights this user possesses.`n"
				. A_Space . A_Space . "Asks for administrator rights, if those are not available,`n"
				. A_Space . A_Space . "it launches with user's rights.`n`n"
				. "requireAdministrator:`n"
				. A_Space . A_Space . "Needs administrator rights to be lauched.`n"
				. A_Space . A_Space . "User has to be a member of Administrators group."
