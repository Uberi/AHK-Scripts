...
FTP_CreateDirectory(byRef hConnect,DirName) {
   ;global ic_hInternet
...
FTP_RemoveDirectory(byRef hConnect,DirName) {
   ;global ic_hInternet
...
FTP_SetCurrentDirectory(byRef hConnect,DirName) {
   ;global ic_hInternet
...
FTP_PutFile(byRef hConnect,LocalFile, NewRemoteFile="", Flags=0) {
   ;Flags:
...
FTP_GetFile(byRef hConnect,RemoteFile, NewFile="", Flags=0) {
   ;Flags:
   ;FTP_TRANSFER_TYPE_UNKNOWN = 0 (Defaults to FTP_TRANSFER_TYPE_BINARY)
   ;FTP_TRANSFER_TYPE_ASCII = 1
   ;FTP_TRANSFER_TYPE_BINARY = 2
...
FTP_GetFileSize(byRef hConnect,FileName, Flags=0) {
   ;Flags:
   ;FTP_TRANSFER_TYPE_UNKNOWN = 0 (Defaults to FTP_TRANSFER_TYPE_BINARY)
   ;FTP_TRANSFER_TYPE_ASCII = 1
   ;FTP_TRANSFER_TYPE_BINARY = 2
...
FTP_DeleteFile(byRef hConnect,FileName) {
   ;global ic_hInternet
...
FTP_RenameFile(byRef hConnect,Existing, New) {
   ;global ic_hInternet
...
FTP_CloseSocket(byRef hConnect) {
...
FTP_FindFirstFile(byRef hConnect, SearchFile, ByRef @FindData) {
...
FTP_GetCurrentDirectory(byRef hConnect,ByRef DirName){
