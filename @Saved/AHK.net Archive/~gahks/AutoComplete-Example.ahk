Gui, Add, Edit, vEdit gEdit w300, Type something
Gui, Show, Autosize, Google - Autocomplete()
return

Edit:
GuiControlGet, Query,, Edit 
Msgbox, % AutoComplete(query)
return
...
{  ; http://www.autohotkey.com/forum/topic33506-30.html
