...
MODIFIED =20080803 v04
CREATED  =20080624
NAME101  =TV_RADIO_YOUTUBE_M3U

TheseToolsToDownload = http://www.autohotkey.net/~garry/20080801_TV_YOUTUBE.zip
ThisScriptToDownload = http://www.autohotkey.net/~garry/20080803_TV_RADIO_YOUTUBE_M3U.ahk
ThisScriptAutohotkey = http://www.autohotkey.com/forum/topic27264.html

;--- login to zattoo  [2008-B/DK/F/D/N/E/CH/GB] ---
mypswrd1=garry12345678
mypswrd2=1234567890
...
USE                              = TV VIDEO YOUTUBE MUSIC M3U PHOTO AUDIORECORD PLAYER
                                   download youtube
...
-MP3GAIN     set level to MP3


LISTVIEW     select predefined folder to search from here
             ( edit /delete / addnew )
             can use UP/DOWN arrow (music/photo)

-FOTO        slide show
-VIDEO       see with predefined size and black background
-MUSIC       M3UPlayer sorted by date
=========================================================================================


                                  audio control works with XP
Vista Audio Control.............  http://www.autohotkey.com/forum/viewtopic.php?t=23792&
...
FLV2MP3 .......................  http://www.dvdvideosoft.com/download/FreeVideoToMp3Converter.exe
                                 http://www.dvdvideosoft.com


.....................................................................................................
diverse links .......... http://www.muvibee.com  plays 50 videos and downloads to mozillacache
...
Zattoo about:
http://zattoo.com/de/help

200808 -receive TV channels in followed countries:
B/DK/F/D/N/E/CH/GB
...
some problems with command=[Gui,add,picture] when using dllbrowse
     only used for colored buttons (need command twice)
     photo slide show better with irfanview

don't know why soundplay not works with mp3/wav on different computers
      mplayerc.exe installed for windows mediaplayer (for me ok)

to record audio level XP:
...
FLV2MP3      =%A_programfiles%\DVDVideoSoft\Free Video to Mp3 Converter\FreeVideoToMP3Converter.exe
...
;-------- menu ----------------------------------------------
     ...
     Menu,S3,add,FLV2MP3 DOWNLOAD  ,MH3
     Menu,S3,add,VIDEOCONVERTER    ,MH3
     Menu,S3,add,ZATTOO TV         ,MH3
...
Gui,2: Add, Picture, gFLV2MP3REC   x%FLV2MP3X%   y%FLV2MP3Y%   w%FLV2MP3W%   h%FLV2MP3H% vFLV2MP35,%GRAY%
Gui,2: Add, Text   ,               x%FLV2MP3X%   y%FLV2MP3Y%   w%FLV2MP3W%   h%FLV2MP3H% cWhite center BackgroundTrans,<FLV2MP3
...
;http://www.youtube.com/watch?v=eE5zyehpYs8&feature=related
;http://www.youtube.com/watch?v=eE5zyehpYs8



URL11=%clipboard%
stringmid,URL11,URL11,1,60    ; not to much letters
...
ifnotexist,%FLV2MP3%
    {
    msgbox,262144,,Download VideoToMp3Converter`r`nhttp://www.dvdvideosoft.com/download/FreeVideoToMp3Converter.exe
    return
    }
...
ifexist,%C3%
      ...
      if ErrorLevel
         {
         MsgBox, WinWait for %FLV2MP3% TfrmMain is timed out.
         return
         }
...
LOGINZATTOO:
Gui,2:submit,nohide
run,%A_programfiles%\Zattoo\Zattoo.exe
      moz=Login
      WinWaitActive, %moz%,,15
      sleep,1000
      send,%mypswrd1%
      sleep,500
      send,{TAB}
...
if A_thisMenuItem=OCTOSHAPE
   goto,OCTOSHAPE1
if A_thisMenuItem=FLV2MP3 DOWNLOAD
   goto,FLV2MP31
if A_thisMenuItem=VIDEOCONVERTER
   goto,VIDEOCONVERTER
if A_thisMenuItem=ZATTOO TV
   goto,ZATTOO1
...
VIDEOCONVERTER:
;run,http://www.dvdvideosoft.com/products/dvd/Free-Video-to-MP3-Converter.htm
...
if A_thisMenuItem=YOUTUBE_RECORDED
   {
   R3XX=%REC%
   goto,crealistviewYoutube
   }

if A_thisMenuItem=MP3_RECORDED
   {
   R3XX=%REC%
   goto,crealistviewMP3REC
   }
...
if A_thisMenuItem=See last version
   {
   run,%ThisScriptAutohotkey%
   return
   }
...
;---------------  example search MP3 ssmunch  ---------------
ATT110:
GuiControl,2:Text,AL1,
gosub,BACKGROUND2

;http://ssmunch.com/?type=mp3
;http://ssmunch.com/?type=lyrics
;http://ssmunch.com/?type=video

aa4=
(
<form name="searchform" onsubmit="if(document.searchform.search.value==''){alert('Sorry your search can not be blank!');return false;}" method="GET" action="http://www.ssmunch.com/index.php">
<input type="text" size="50" name="search" />
<input type="submit" name="submit" value="Search for MP3" />
...
GuiControl,2:Disable,EDITLV
    ...
    GuiControl,2:Disable,FLV2MP3REC5
    Gui,2: Add, Text   ,               x%FLV2MP3X%   y%FLV2MP3Y%   w%FLV2MP3W%   h%FLV2MP3H% cBlack center BackgroundTrans,<FLV2MP3
    Gui,2: Add, Text   ,               x%FLV2MP3X%   y%FLV2MP3Y%   w%FLV2MP3W%   h%FLV2MP3H% cBlack center BackgroundTrans,<FLV2MP3
...
gosub,disableall
    ...
    GuiControl,2:Enable,FLV2MP3REC5
    Gui,2: Add, Text   ,               x%FLV2MP3X%   y%FLV2MP3Y%   w%FLV2MP3W%   h%FLV2MP3H% cWhite center BackgroundTrans,<FLV2MP3
    Gui,2: Add, Text   ,               x%FLV2MP3X%   y%FLV2MP3Y%   w%FLV2MP3W%   h%FLV2MP3H% cWhite center BackgroundTrans,<FLV2MP3
...
process,close,%PIDX%
soundplay,notexisted.mp3  ;stop playing
if (R3XX="MUSIC" OR R3XX="PHOTO" OR R3XX="MP3REC")
    {
    GuiControl,2:Enable,PLAY5
    Gui,2: Add, Text   ,               x%PLAYX%    y%PLAYY%    w%PLAYW%    h%PLAYH% cWhite center BackgroundTrans,<PLAY
    Gui,2: Add, Text   ,               x%PLAYX%    y%PLAYY%    w%PLAYW%    h%PLAYH% cWhite center BackgroundTrans,<PLAY
...
;*/
                 ...
                 ifexist,%MPL%
                    {
                    ;Loop,%C3%,1
                    ;SP7= %A_LoopFileShortPath%                ;shortpath for DOS command
                    ;msgbox,%SP7%
                    ;return
                    run,"%MPL%" "%C3%",,,PIDX
                    Process,wait,mplayerc.exe
...
;------------- COLUMN D ------------------------------------
      ...
      if R3XX=%R3W%                ;YOUTUBE LOG STREAM
        {
        LV_GetText(C1,A_EventInfo,1)
        LV_GetText(C2,A_EventInfo,2)
        LV_GetText(C3,A_EventInfo,3)
        ...
        /*
        ;---- works for fresh downloaded movies
        URL2=%C3%
        if (C4="DNL")
           {
...
;-------------- UP / DOWN -----------------------------------
if (R3XX="MUSIC" OR R3XX="PHOTO" OR R3XX="MP3REC")                  ;only music or photo
{
if A_GuiEvent=K
 {
...
if (R3XX="MUSIC" OR R3XX="VIDEO" OR R3XX="PHOTO" OR R3XX="MP3REC")
   {
   GuiControl,2:Text,Counter1,
   RN:=LV_GetNext("C")  ;2  selected checked
   RF:=LV_GetNext("F")  ;2  selected focused
...
EE1=
(
TheseToolsToDownload .................: %TheseToolsToDownload%
ThisScriptToDownload .................: %ThisScriptToDownload%
ThisScriptAutohotkey .................: %ThisScriptAutohotkey%

can use also TOOLS menu to download missing standalone tools

To see embed TV / internet needs lbbrowse3.dll

How to download Youtube ( also when removed )
- start this script and youtube, use right mouse button in youtube to copy link
  show youtube embedded in script which you can play or download
  creates a YoutubeLogFile to download later
  click on column D  DNL to download

- How to record/play internet radio:
  SELECT RADIO and click column D REC > shoutcast downloads every song
  click column A to listen
  needs streamripper.exe  &  tre.dll

- How to watch TV:
  SELECT TELEVISION   , click column A to watch

- How to record audio what you hear:
  click AUDIO-RECORD use WAVE / STEREOMIX  button to control LEVEL
  needs mixmp3.exe

LISTVIEW: edit/addnew/delete multiple marked lines (textfile)
-EDIT/DELETE  mark desired row when click the left part from column A

-VIDEO
-PHOTO
-MUSIC
-M3U     sorted by date example see the last saved 20 music files

-create a predefined folder to search from here
-create an xy.m3u file shown in listview
 you can mark row (right D column) and play song from here (PLAY-button)
...
-record audio with mixmp3.exe       & mp3enc.dll
-record radio with streamripper.exe & tre.dll
----------------------------------------------------------------------------------------

Vista Audio Control.............  http://www.autohotkey.com/forum/viewtopic.php?t=23792&

Embed TV INTERNET............... = lbbrowse3.dll
................................  http://www.alycesrestaurant.com/lbbrowse.htm
................................  http://www.alycesrestaurant.com/zips/browsdll3.zip
...
ifnotexist,%R3R%
  {
  Fileappend,_RADIO LISTENLIVE;http://www.listenlive.eu/;`r`n,%R3Ra%
...
ifnotexist,%R3T%
  ...
  */
  ...
  Fileappend,__ZATTOO;C:\Programme\Zattoo\Zattoo.exe;`r`n,%R3Ta%
  Fileappend,_SHOUTCAST RADIO;http://www.shoutcast.com/;`r`n,%R3Ta%
  Fileappend,_RADIO LISTENLIVE;http://www.listenlive.eu/;`r`n,%R3Ta%
...
ifnotexist,%R3S%
  ...
  Fileappend,MUSIC MUNCH;http://ssmunch.com/;`r`n,%R3Sa%
/*
  Fileappend,`r`n,%R3Sa%
  Fileappend,`r`n,%R3Sa%
  Fileappend,`r`n,%R3Sa%
...
;msgbox,URL2=%URL2% REC=%REC%  F2=%F2%
;return

;Forest Trio   c Alexey Alexeev;
;URL2=http://www.youtube.com/watch?v=-oMdJJN1XVo
;http://www.youtube.com/get_video?video_id=-oMdJJN1XVo&l=117&sk=0U5dsOnMX-hSUqtuX0TNflVN-O6wGvd6C&fmt_map=&t=OEgsToPDskIM56nRI6OQd7ZP7kL_V-WB&hl=en&plid=AARTd9jA0kFaaXGCAAACoAAYAAA
;URL2=http://www.youtube.com/get_video?video_id=-oMdJJN1XVo&l=117&sk=0U5dsOnMX-hSUqtuX0TNflVN-O6wGvd6C&fmt_map=&t=OEgsToPDskIM56nRI6OQd7ZP7kL_V-WB


;Splashimage,,b w600 h30  CWlime m9 b fs10 zh0,DOWNLOAD >>> %F2%
SplashImage,Download,CWLIME x%X15% y%Y27% h40 w800 m2,DOWNLOAD >>> %F2%
URLDownloadToFile,%URL2%,%REC%\%F2%
;URLDownloadToFile,%URL2%,%REC%\test.flv
Splashimage, off
...
;================= DOWNLOAD lbbrowse3.dll / or all programs ===================
LBBROWSE3:
{
   text31=
(
This ahk-script needs at least lbbrowse3.dll

Download

Embed............................... = lbbrowse3.dll
Streamripper record internet radio.. = streamripper.exe   &   tre.dll
audio level meter .................. = meterh.exe
MIXMP3  record what you hear ....... = MIXMP3.exe  &  mp3enc.dll
MP3GAIN set MP3 level .............. = mp3gain.exe

from
http://www.autohotkey.net/~garry
