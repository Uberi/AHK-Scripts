...
BF_RECT := (BF_LEFT OR BF_TOP | BF_RIGHT | BF_BOTTOM)
BF_DIAGONAL := 0010
BF_DIAGONAL := 0010
...
SC_MINIMIZE := 0x0F020
SC_MAXIMIZE := 0x0F030
SC_NEXTWINDOW := 0x0F040
SC_PREVWINDOW := 0x0F050
SC_CLOSE := 0x0F060
SC_VSCROLL := 0x0F070
SC_HSCROLL := 0x0F080
SC_MOUSEMENU := 0x0F090
SC_KEYMENU := 0x0F100
SC_ARRANGE := 0x0F110
SC_RESTORE := 0x0F120
SC_TASKLIST := 0x0F130
SC_SCREENSAVE := 0x0F140
SC_HOTKEY := 0x0F150
SC_DEFAULT := 0x0F160
SC_MONITORPOWER := 0x0F170
SC_CONTEXTHELP := 0x0F180
SC_SEPARATOR := 0x0F00F
SC_ICON := SC_MINIMIZE
SC_ZOOM := SC_MAXIMIZE
SC_ZOOM := SC_MAXIMIZE
IDC_ARROW := 32512
...
WINEVENT_INCONTEXT := 0x0004
OBJID_WINDOW := 0x000000000
OBJID_SYSMENU := 0x0FFFFFFFF
OBJID_TITLEBAR := 0x0FFFFFFFE
OBJID_MENU := 0x0FFFFFFFD
OBJID_CLIENT := 0x0FFFFFFFC
OBJID_VSCROLL := 0x0FFFFFFFB
OBJID_HSCROLL := 0x0FFFFFFFA
OBJID_SIZEGRIP := 0x0FFFFFFF9
OBJID_CARET := 0x0FFFFFFF8
OBJID_CURSOR := 0x0FFFFFFF7
OBJID_ALERT := 0x0FFFFFFF6
OBJID_SOUND := 0x0FFFFFFF5
OBJID_SOUND := 0x0FFFFFFF5
...
STATE_SYSTEM_REDUNDANT := 0x20000000
STATE_SYSTEM_ONLY_REDUNDANT := 0x40000000
