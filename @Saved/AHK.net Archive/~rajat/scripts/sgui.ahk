...
Menu, FileMenu, Add, &New, Reload
Menu, FileMenu, Add, &Open, EditGUI
Menu, FileMenu, Add, &Test`t[F9], TestGUI
Menu, FileMenu, Add, &Save, SaveGUI2
Menu, FileMenu, Add, Save &As, SaveGUI
Menu, FileMenu, Add
Menu, FileMenu, Add, E&xit, GuiClose


Menu, ExtraMenu, Add, GUI St&ealer, Stealer
Menu, ExtraMenu, Add, Set GUI Count in Script, SetGUICount

Menu, HelpMenu, Add, `:`: SmartGUI Creator by Rajat `:`:, About
Menu, HelpMenu, Default, `:`: SmartGUI Creator by Rajat `:`:
...
Menu, ToolBarMenu, Add, &Extra, :ExtraMenu
...
Gui, 9:Add, ListBox, x1 y45 w3200 h2400 +Disabled
Gui, 9:Color,, 686A69
...
GenerateGUI:
	...
	Loop, Parse, ItemList, |
	{
		...
		Loop, Parse, Buffer, `n
		{
			...
			{
				FinalScript = %FinalScript%Gui`, %GUICountA%Font`, %Options%`, %CtrlText%`n
				Continue
			}
