;Mouse Hover for iswitchw 0.9 beta with some issues by noob1999
;*MOD*-----------------------------------------------------------------------
...
;*MOD*-----------------------------------------------------------------------
Gui,Font,s16 c778899 bold,Arial
...
;*MOD*-----------------------------------------------------------------------
                    ...
                    stringleft, procname, procname, 4
                }

                stringupper, procname, procname
                title = %procname%%a_tab%%title%
            }
...
ReloadScriptIfChanged:
  ...
  IfInString, FileAttribs, A
  {
    ...
    Tooltip,Reloading Script... %A_ScriptName%
    Reload
...
MouseTrack:
   MouseGetPos,PosX,PosY, id, control
   WinGetTitle, Title, ahk_id %id%
      
   IfInString, Title, Window Switcher ;if inside the window
   {
   
      If (not PosX = PrevPosX and not PosY = PrevPosY)
      {
         MouseClick,,,,,,D
         GoSuB ActivateWindowInBackgroundIfEnabled
       }
